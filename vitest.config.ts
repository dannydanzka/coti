...
export default defineConfig({
  ...
  test: {
    ...
    css: false,
    environment: 'jsdom',
    // @ts-expect-error - environmentMatchGlobs sigue soportado en runtime, ausente de los types de Vitest v4
    ...
    /** Fail fast: a healthy unit test finishes in ms — a hang should die in 1s. */
    testTimeout: 1000,
  },
});
