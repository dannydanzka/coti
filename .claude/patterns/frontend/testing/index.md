...
| `e2e-playwright.md` | Modern E2E doc (Playwright 1.59, Vitest-era): config, auth pattern, POM, locale locators, credentials security, two-channel coverage, `e2e-testing-policy` rule (elevated from sovertainty) |
