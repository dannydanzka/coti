...
| `ast-mirroring-codemods.md` | Finishing large rule-driven refactors (>20 sites) by parsing with the real AST and mirroring the rule's own detection logic | Medium |
...
**Total**: 8 patterns | **Updated**: 2026-07-06 (ast-mirroring-codemods elevated from followme)
