...
- the project's `.claude/patterns/business/reference/api-testing-config.md` — Test user table (env var references)
- the project's `.claude/patterns/business/sops/manual-testing-monitoring.md` — Manual QA with curl
- the project's `.claude/patterns/business/sops/manual-testing-flows.md` — Module-specific manual flows
