...
the project's own `.claude/rules/team.md`
...
| Team members + UUIDs | the project's own `.claude/rules/team.md` | Project-specific |
| Active projects | the project's own `.claude/status/` | Project-specific |
