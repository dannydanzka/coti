...
| `authorization-boundary.md` | What may be done freely, what is announced, what is asked every time + the exception format | Any session, any domain |
| `definition-of-done.md` | The single gate before the word "done" | Closing any task |
| `root-cause-analysis.md` | Two levels below the symptom before proposing a fix | A symptom appears |
