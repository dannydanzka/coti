...
export const brandColor = {
  ...
  landingOrange: '#E06A1F',
  landingOrangeDark: '#C75A12',
  landingPinkLight: '#FFB8E8',
  landingPinkRgb: '255, 0, 178',
  landingPinkVibrant: '#FF00B2',
  landingTextBody: '#5C4B3B',
  landingTextDark: '#3B2A1D',
...
export const typography = {
  family: {
    ...
    rounded: "var(--font-rounded), 'Lato', sans-serif",
  },
  leading: {
    normal: 1.5,
    relaxed: 1.75,
